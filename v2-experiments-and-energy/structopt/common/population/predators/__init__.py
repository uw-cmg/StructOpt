...
class Predators(object):
    ...
    def __init__(self, parameters):
        ...
        print('parameters in predatot', self.parameters)
    ...
    def kill(self, population, nkeep, keep_best=True):
        ...
        # delete the FEMSIM data of the killed individual
        for idv_killed in killed:
            print('idv_folder')
            if 'FEMSIM' in idv_killed.fitnesses.module_names and idv_killed.fitnesses.FEMSIM.folder != None:
                print(idv_killed.fitnesses.FEMSIM.folder)
                shutil.rmtree(idv_killed.fitnesses.FEMSIM.folder)            
